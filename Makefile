##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.17.1] date: [Wed Aug 17 17:12:43 TRT 2022] 
##########################################################################################################################
...
# *** EOF ***
install:
	st-flash write build/l4_light_thing.bin 0x08000000

#install_full:
#	st-flash write build/blackpill_fullbinary.bin 0x08000000

lldb:
	lldb build/l4_light_thing.elf

#lldb_bl:
# lldb bootloader/build/blackpill_bootloader.elf

gdb:
	gdb build/l4_light_thing.elf
...
#install_bl:
#	st-flash write bootloader/build/blackpill_bootloader.bin 0x08000000
